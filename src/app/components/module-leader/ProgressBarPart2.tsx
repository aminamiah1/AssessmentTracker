...
export function ProgressBarPart2({
  ...
  return isComplete ? (
    ...
    >
      <div
        className={
          "absolute h-6 w-6 rounded-full bg-green-600 top-[3em] right-0 max-[1433px]:invisible"
        }
      ></div>
      <div
    ...
    >
      ...
      <div
        className={
          isOverDue
            ? "absolute h-6 w-6 rounded-full bg-red-600 top-[4.6em] right-0 max-[1433px]:invisible"
