  ...
  return (
    <>
      ...
      <aside
        ...
        } bg-white border-r border-gray-200 sm:relative sm:translate-x-0 sm:w-64 dark:bg-gray-800 dark:border-gray-700`}
        aria-label="Sidebar"
      >
      ...
      <div>
        <main className="top-[7vh] w-full">{children}</main>
      </div>
    </>
  );
};
