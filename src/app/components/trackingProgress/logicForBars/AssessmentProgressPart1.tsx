...
export default function AssessmentProgressPart1({
  ...
  const isComplete =
    lastCompletedPartTitle === "External examiner feedback monitoring" ||
    lastCompletedPartTitle === "Sample availability" ||
    lastCompletedPartTitle === "Internal moderation of marked sample" ||
  ...
  return (
    <div className="w-full flex justify-evenly rounded p-4">
      <div className="w-[100%] relative overflow-hidden text-left">
